    ...
    <div>
      ...
      <div className="grid sm:grid-cols-1 md:grid-cols-2 mt-16 mx-10 gap-10 mb-32">
        <div class="card lg:card-side bg-base-100 shadow-xl">
          ...
          <div class="card-body">
            <h2 class="card-title">Make exercise a daily habit - 8 tips</h2>
            ...
            <div class="card-actions justify-end">
              <a href="https://www.hsph.harvard.edu/nutritionsource/2013/11/04/making-exercise-a-daily-habit-10-tips/"> <button class="py-2 px-4 bg-cyan-700 text-white font-semibold rounded-lg shadow-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-opacity-75">See more..</button></a>
        ...
        <div class="card lg:card-side bg-base-100 shadow-xl">
          ...
          <div class="card-body">
            <h2 class="card-title">Helpful tips for Fitness and Nutrition</h2>
            <p>1. Stay Hydrated</p>
            ...
            <div class="card-actions justify-end">
              <a href="https://www.health.com/weight-loss/30-simple-diet-and-fitness-tips"> <button class="py-2 px-4 bg-cyan-700 text-white font-semibold rounded-lg shadow-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-opacity-75">See more..</button></a>
