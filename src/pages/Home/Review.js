...
const Review = () => {
    return (
        <div>
            ...
            <div className='grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 md:ml-16 ml-5 mb-12 mt-12 gap-4 font-mono'>
  ...
  <div class="card-body">
    ...
    <div class="card-actions justify-end">
      <button class="py-2 px-4 bg-cyan-700 text-white font-semibold rounded-lg shadow-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-opacity-75">See more</button>
    </div>
  </div>
</div>
            <div class="card card-compact w-80 bg-base-100 shadow-xl">
